...
<title>Inventario | Añadir productos</title>
<!-- CSS BOOTSTRAP -->
...
<div class="list-group list-group-flush overflow-auto h-100 ">
    ...
    <div id="page-content-wrapper">
        ...
        <h1 class="mt-4 ml-2 text-center lead">Añadir Productos</h1>
...
<label class=" mb-2">Nombre del producto:</label>
        <input type="text" class="form-control" placeholder="Ej. Camisa Roja" aria-label="Nombre Producto" name="nombre" required>
        </div>
    </div>
    <br>
          <div class="row">
          ...
          <label class="mb-2">Precio entrada ($):</label>
            <input type="number" class="form-control"  name="precioEntrada" required>
          </div>
        </div><br>
        <div class="row">
          <div class="col">
          <label class="mb-2">Categoria:</label>
            <input type="text" class="form-control" placeholder="Ej. Camisetas" name="categoria" required>
          </div>
          <div class="col">
  ...
  <textarea class="form-control" id="exampleFormControlTextarea1" name="descripcion" rows="3"></textarea>
    ...
    <br>
      ...
      <button class="btn btn-success mb-4" type="submit" name="registroproductos" value="getvalues">Añadir producto</button>
      </div>
      </div>
    </div>
        </form>
...
$consulta = "INSERT INTO productos(nombree, ruta, nombre, precioEntrada, categoria, cantidad, descripcion) VALUES ('$nombreImg', '$destino', '$nombre', '$precioEntrada',
